		...
		if (!in_array($article->catid,$exceptcat)) {
			...
			if ($view == 'article') {
				...
				if ($this->params->def('showvkontakte')) {
					...
					$doc->addCustomTag('<script type="text/javascript" src="//vk.com/js/api/openapi.js?146"></script>');$doc->addCustomTag('<script type="text/javascript">VK.init({apiId: '.$apiId.', onlyWidgets: true});</script>');			
				}
				else {}
